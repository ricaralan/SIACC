  ...
  */
  ...
  INSERT INTO permiso(id_permiso, per_nombre, per_nombre_corto, per_url, per_descripcion) VALUES("mesa_ayuda_atencion", "Mesa de ayuda en modo atencion de solicitudes", "mesa de ayuda", "/mesa_ayuda", "Modulo de mesa de ayuda de tipo 2: Es control en modo de atencion de solicitudes");
  INSERT INTO permiso(id_permiso, per_nombre, per_nombre_corto, per_url, per_descripcion) VALUES("mesa_ayuda_solicitante", "Mesa de ayuda en modo solicitante", "mesa de ayuda", "/mesa_ayuda", "Modulo de mesa de ayuda de tipo 3: Es control en modo solicitante de servicios");
